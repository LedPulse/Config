...
#define LEDS_PER_STRING     60      // LEDs per string
#define BUFFER_SIZE         15365   // Data buffer size (120 * 32 * 4 + 5)
...
uint8_t buffer[BUFFER_SIZE];    // Buffer for 32 LED strings * 120 dots * 4 bytes + header
...
void dma_init(void) 
{
    ...
    dma_config.DMA_BufferSize = LED_DOTS * LED_STRINGS * 4 + 5;  // 120 * 32 * 4 + 5 = 15365 bytes
