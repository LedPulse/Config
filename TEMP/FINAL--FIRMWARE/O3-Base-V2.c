...
/* Defines -------------------------------------------------------------------*/
#define LED_DOTS            96      // Number of dots per LED string
#define DELAY_0             36      // Short delay timing
#define DELAY_1             36      // Long delay timing
#define LED_STRINGS         32      // Number of LED strings
#define LEDS_PER_STRING     96      // LEDs per string
#define BUFFER_SIZE         12293   // Data buffer size (96 * 32 * 4 + 5)
...
uint8_t buffer[BUFFER_SIZE];    // Buffer for 32 LED strings * 96 dots * 4 bytes + header
...
void dma_init(void) 
{
    ...
    dma_config.DMA_BufferSize = LED_DOTS * LED_STRINGS * 4 + 5;  // 96 * 32 * 4 + 5 = 12293 bytes
